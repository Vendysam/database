-- Active: 1707482431940@@127.0.0.1@3306@tessy_table
...
CREATE TABLE `offices` (
     Officeid int NOT NULL AUTO_INCREMENT PRIMARY KEY ,
    LastName varchar(255) NOT NULL,
    FirstName varchar(255),
    Age int  
      ) ; 

INSERT INTO `offices` VALUES (' Reinke Trail','Cincinnati', 32);
INSERT INTO `offices` VALUES ('5507 Becker Terrace','New York City','23');
